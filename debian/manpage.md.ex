% trustedgrub2(SECTION) | User Commands
%
% "July 29 2023"
...
trustedgrub2 - program to do something

# SYNOPSIS

**trustedgrub2** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**trustedgrub2** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **trustedgrub2** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**trustedgrub2** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    trustedgrub2. See **foo.conf**(5) for further details.
...
**trustedgrub2** provides some return codes, that can be used in scripts:
